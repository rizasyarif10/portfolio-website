    ...
    <>
      ...
      >
        <div className="relative h-[45%] min-h-[255px] overflow-hidden bg-[#d8d8d0] max-[900px]:h-full max-[900px]:min-h-0 max-[620px]:h-[clamp(290px,90vw,360px)] max-[620px]:min-h-[clamp(290px,90vw,360px)]">
          ...
          <LanguageToggle />
          <ThemeToggle />
          <span className="absolute right-4 bottom-4 left-4 z-[1] flex w-fit items-center gap-2 rounded-full border border-white/55 bg-[rgba(247,245,238,0.9)] px-3 py-[9px] text-[10px] font-bold text-[#192c3e] backdrop-blur-lg">
            <i className="size-[7px] rounded-full bg-[#43a34c] shadow-[0_0_0_3px_rgba(67,163,76,0.17)]" />
            {localize(PROFILE.availability, language)}
          </span>
        </div>
        <div className="flex min-h-0 flex-1 flex-col p-7 max-[1120px]:p-[23px] max-[620px]:min-h-0 max-[420px]:p-5">
          <p className="mb-[11px] text-[11px] font-bold tracking-[0.12em] text-[#8f9f7f] uppercase dark:text-[#b4c0a5]">
          ...
          <p className="mt-[17px] flex items-center gap-[7px] text-[11px] text-white/65 max-[420px]:text-[10px]">
