...
export function PdfPreviewModal({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[100] grid place-items-center p-[22px] max-[620px]:p-2" role="dialog" aria-modal="true" aria-labelledby="pdf-preview-title">
      ...
      <div className="relative grid h-[calc(100dvh_-_44px)] max-h-[880px] w-full max-w-[960px] grid-rows-[auto_minmax(0,1fr)_auto] overflow-hidden rounded-3xl border border-white/30 bg-[#f7f5ee] shadow-[0_30px_90px_rgba(12,22,31,0.38)] max-[620px]:h-[calc(100dvh_-_16px)] max-[620px]:rounded-[18px] dark:border-[#8fb7ff]/15 dark:bg-[#0b1726] dark:text-[#edf1f8]">
        <header className="flex items-center justify-between border-b border-[rgba(25,44,62,0.12)] bg-[#f7f5ee] px-[18px] py-[15px] max-[620px]:px-3 max-[620px]:py-[11px] dark:border-[#8fb7ff]/15 dark:bg-[#0b1726]">
