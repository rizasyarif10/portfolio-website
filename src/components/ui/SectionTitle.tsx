...
export function SectionTitle({ number, title, note }: SectionTitleProps) {
  return (
    <div className="mb-[42px] max-[420px]:mb-8">
      ...
      <div className="grid grid-cols-[minmax(0,1fr)_minmax(220px,0.68fr)] items-end gap-8 max-[720px]:grid-cols-1 max-[720px]:gap-3">
        ...
        {note && (
          <p className="max-w-[430px] border-l-2 border-[#d28a22]/55 pl-4 text-[13px] leading-[1.65] text-[rgba(25,44,62,0.58)] max-[420px]:text-[12px] dark:text-[rgba(237,241,239,0.61)]">
            {note}
          </p>
        )}
      </div>
